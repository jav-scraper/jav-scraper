...
export const settings: Settings = {
  ...
  "sort.metadata.priority.coverurl": ["jav321", "javdb"],
  "sort.metadata.priority.description": ["javdb", "jav321"],
  "sort.metadata.priority.director": ["javdb", "jav321"],
  "sort.metadata.priority.genre": ["javdb", "jav321"],
  "sort.metadata.priority.id": ["javdb", "jav321"],
  ...
  "sort.metadata.priority.posterurl": ["jav321", "javdb"],
  ...
  "sort.metadata.priority.screenshoturl": ["jav321", "javdb"],
  "sort.metadata.priority.title": ["javdb", "jav321"],
  "sort.metadata.priority.trailerurl": ["javdb", "jav321"],
