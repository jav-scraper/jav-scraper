...
export const settings: Settings = {
  throttlelimit: 3,
  "location.input": "/mnt/f/JAV/Unsorted",
  ...
  "sort.metadata.priority.actress": ["dmm", "javdb", "jav321"],
  "sort.metadata.priority.coverurl": ["dmm", "jav321", "javdb"],
  "sort.metadata.priority.description": ["dmm", "javdb", "jav321"],
  "sort.metadata.priority.director": ["dmm", "javdb", "jav321"],
  "sort.metadata.priority.genre": ["dmm", "javdb", "jav321"],
  "sort.metadata.priority.id": ["dmm", "javdb", "jav321"],
  "sort.metadata.priority.contentid": ["dmm", "javdb", "jav321"],
  "sort.metadata.priority.label": ["dmm", "javdb", "jav321"],
  "sort.metadata.priority.maker": ["dmm", "javdb", "jav321"],
  "sort.metadata.priority.posterurl": ["dmm", "jav321", "javdb"],
  "sort.metadata.priority.releasedate": ["dmm", "javdb", "jav321"],
  "sort.metadata.priority.releaseyear": ["dmm", "javdb", "jav321"],
  "sort.metadata.priority.rating": ["dmm", "javdb", "jav321"],
  "sort.metadata.priority.runtime": ["dmm", "javdb", "jav321"],
  "sort.metadata.priority.series": ["dmm", "javdb", "jav321"],
  "sort.metadata.priority.screenshoturl": ["dmm", "jav321", "javdb"],
  "sort.metadata.priority.title": ["dmm", "javdb", "jav321"],
  "sort.metadata.priority.trailerurl": ["dmm", "javdb", "jav321"],
